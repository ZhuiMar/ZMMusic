...
class WLTBuddhistMusicVC: UIViewController {
...
//        collectionView.mj_header = MJRefreshNormalHeader(refreshingTarget: self, refreshingAction: #selector(WLTBuddhistMusicVC.loadNewData))
...
extension WLTBuddhistMusicVC: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension WLTBuddhistMusicVC: LZYWaterfallLayoutDelegate {
