...
struct ZYPageStyle {
    ...
    var normalColor : UIColor = hexColor("666666") // 文本普通的颜色
    var selectColor : UIColor = hexColor("baa574") // 文本选中的颜色
    ...
    var bottomLineColor : UIColor = hexColor("baa674") // 滚动条默认的颜色
    ...
    var coverViewAlpha : CGFloat = 0.1 // 透明度
