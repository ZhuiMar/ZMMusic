...
class ZYTittleView: UIView,UIScrollViewDelegate {
    ...
    var tittleLables : [UILabel] = [UILabel]()
    ...
    // MARK: 构造函数
    init(frame: CGRect, tittles : [String], style : ZYPageStyle, currentPage: Int) {
...
extension ZYTittleView {
    ...
    func refreshCurrentPage() {
        ...
        delegate?.tittleView(self, targetIndex: currentIndex)
    ...
    private func setupTittles() {
        ...
        for (i , tittle) in tittles.enumerated() {
            ...
            tittleLable.textColor = i == self.currentPage ? style.selectColor : style.normalColor
