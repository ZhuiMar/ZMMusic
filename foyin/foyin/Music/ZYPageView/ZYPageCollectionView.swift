...
class ZYPageCollectionView: UIView {
    ...
    init(frame:CGRect , titles:[String], style:ZYPageStyle , layout: ZYPageCollectionViewLayout, currentIndex: Int) {
        self.titles = titles
        self.style = style
        self.layout = layout
...
extension ZYPageCollectionView {
    ...
    fileprivate func setupUi() {
        ...
        let titleView = ZYTittleView(frame: titleFrame, tittles: titles, style: style, currentPage: currentPage)
